...
public class Summarizing {
    public static void main(String... args) {
        ...
        System.out.println("Total calories in Dish.menu: " + calculateTotalCalories());
        System.out.println("Average calories in Dish.menu: " + calculateAverageCalories());
        System.out.println("Menu statistics: " + calculateMenuStatistics());
        System.out.println("Short Dish.menu: " + getShortMenu());
        System.out.println("Short Dish.menu comma separated: " + getShortMenuCommaSeparated());
    }
