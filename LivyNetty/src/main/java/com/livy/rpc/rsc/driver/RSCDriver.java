...
package com.livy.rpc.rsc.driver;
...
import com.livy.rpc.client.common.Serializer;
import com.livy.rpc.rsc.BaseProtocol;
import com.livy.rpc.rsc.BypassJobStatus;
import com.livy.rpc.rsc.FutureListener;
import com.livy.rpc.rsc.RSCConf;
import com.livy.rpc.rsc.Utils;
...
public class RSCDriver extends BaseProtocol {
  ...
  public RSCDriver(SparkConf conf, RSCConf livyConf) throws Exception {
    ...
    this.jobQueue = new LinkedList<JobWrapper<?>>();
